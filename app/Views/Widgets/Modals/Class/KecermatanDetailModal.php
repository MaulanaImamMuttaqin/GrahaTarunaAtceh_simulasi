<div id="kecermatanDetailModal" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal  md:h-full md:inset-0">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-between items-start p-5 rounded-t border-b dark:border-gray-600">
                    ...
                    <div class="flex gap-2">
                        <button id="delete_test_kecermatan" type="button" class="w-10 center text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                        ...
                        <button type="button" class="w-10 center text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" onclick="editDetailMode(this)">
                            <i class="fa-solid fa-pen-to-square"></i>                        
                        </button>
                        <button id="close_kecermatan_modal" type="button" class="w-10 center text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <div class= "p-6 ">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-2 flex  gap-3 items-center p-1 justify-center">
