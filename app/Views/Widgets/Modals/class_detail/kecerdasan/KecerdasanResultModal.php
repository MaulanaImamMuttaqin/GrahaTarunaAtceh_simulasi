<div id="test_kecerdasan_result" class="hidden p-3 flex flex-col gap-3 ">
    <div class="border border-gray-200 flex justify-between items-center p-3">
        <div>
            ...
            <div class="flex  gap-1 ">
                ...
                <p> :</p>
                <p id="participant_kecerdasan_result_is_passed"></p>
            </div>
        </div>
        <div class="flex border border-gray-200 text-2xl p-3">
            <p class="border-r border-gray-200 p-2">Nilai</p>
            <p class="p-2 text-white font-bold" id="participant_kecerdasan_final_result">65.44</p>
        </div>
    </div>
            ...
            <div class="overflow-y-auto max-h-[200px] sm:-mx-6 lg:-mx-8">
                <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden shadow-md sm:rounded-lg">
                        <table class="min-w-full" id="participant_kecerdasan_result_table">
        ...
        <div class="border-b border-gray-200">
            <div class="flex justify-between">
                ...
                <div class="flex justify-evenly w-52 border border-black">
                    <p class="flex-1 text-center" id="participant_kecerdasan_result_correct">-</p>
                </div>
            </div>
            <div class="flex justify-between">
                <p>Total Salah</p>
                <div class="flex justify-evenly w-52 border border-black">
                    <p class="flex-1 text-center" id="participant_kecerdasan_result_wrong">-</p>
                </div>
            </div>
            <div class="flex justify-between">
                <p>Total Soal</p>
                <div class="flex justify-evenly w-52 border border-black">
                    <p class="flex-1 text-center" id="participant_kecerdasan_result_total">-</p>
                </div>
            </div>
        </div>
        <div class="flex justify-between">
            <p>Nilai Akhir</p>
            <div class="flex justify-evenly w-52 border border-black">
                <p class="flex-1 text-center font-bold" id="participant_kecerdasan_result_final">-</p>
            </div>
        </div>
    </div>
</div>