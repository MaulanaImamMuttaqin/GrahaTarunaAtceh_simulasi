<div id="single_question_editor" class="hidden p-3 flex min-h-[300px] max-h-[500px] overflow-auto flex-col gap-3 w-full rounded-lg z-50">
    ...
    <div id="kepribadian_question_input" class="editor_questions_input w-full py-2 px-1 border border-gray-300 shadow-lg text-gray-700 rounded-lg">
        
    </div >
    <label for="kepribadian_question_input">Masukkan Jawaban</label>
    <select id="kepribadian_key_input" class="editor_questions_input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="kepribadian_options options pl-10 flex flex-col gap-2">
        <div class="flex gap-2 items-center">
            <!-- <span>A. </span> -->
            <div class="editor_questions_input kepribadian_options_input w-full py-2 px-1 border border-gray-300 shadow-lg text-gray-700 rounded-lg" ></div>
        </div>
        <div class="flex gap-2 items-center">
            <!-- <span>B. </span> -->
            <div class="editor_questions_input kepribadian_options_input w-full py-2 px-1 border border-gray-300 shadow-lg text-gray-700 rounded-lg" ></div>
