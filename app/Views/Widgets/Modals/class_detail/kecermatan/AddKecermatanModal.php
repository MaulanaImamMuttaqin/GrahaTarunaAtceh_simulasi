<div id="addKecermatanModal" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0">
            <div class="relative px-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700  h-[600px] overflow-y-auto">
                    ...
                    <div class="flex justify-between items-start p-5 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="addKecermatanModal">
                            <i class="fa-solid fa-xmark"></i>
                        </button>
                    </div>
                    <div class="px-5">
                        <button id="toggle_test_kecermatan_mode" id="toggle-mode" type="button" class=" flex gap-5 items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" >
                            <i class="fa-solid fa-chevron-down"></i>
                            <span id="mode-otomatis" class="hidden text-sm font-normal">Atur Soal Secara Otomatis</span>
                            <span id="mode-manual" class="text-sm font-normal"> Masukkan Soal Secara Manual</span>
                        </button>
                    </div>
                    <form id="add_test_kecermatan_form" action="javascript:void(0)">
                        ...
                        <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                            ...
                            <button data-modal-toggle="addKecermatanModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">Batal</button>
                        </div>
                    </form>
                    <form id="add_test_kecermatan_form_manual" action="javascript:void(0)" class="hidden">
                        <div class="p-6 space-y-6">
                            ...
                            <div id="dropdown-input-manual" >
                                ...
                                <div class="flex gap-5">
                                    <div id="read_question_file_button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:cursor-pointer">Import</div>
