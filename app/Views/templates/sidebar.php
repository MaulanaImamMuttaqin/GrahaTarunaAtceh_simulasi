    ...
    <div class="px-3 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 h-full flex flex-col justify-between relative p-10 py-20 " >
        ...
        <ul class="space-y-2 ">
            ...
            <li>
                <a href="<?= base_url('operator/test_list')?>" class="flex items-center px-5 p-2 text-base font-normal text-blue-700 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700">
