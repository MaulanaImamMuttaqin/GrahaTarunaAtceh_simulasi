...
<div class="h-full w-full flex flex-col p-10">
    ...
    <?= view_cell('\App\Libraries\Widget::title_header', ['title'=> 'Daftar Kelas'])?>
    ...
    <div class="w-full">
        ...
        <div class="flex flex-col w-full max-h-96 overflow-hidden">
            <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden  shadow-md sm:rounded-lg">
                        
                        <table id="class_list_table" class="min-w-full">
                            ...
                            <tbody >
                                <?= view_cell('\App\Libraries\Widget::class_list', ['data'=> $data]) ?>
                            </tbody>
                        </table>
                    </div>
                </div>
