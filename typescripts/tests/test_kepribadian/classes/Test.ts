...
import { question_list_type, answer, Answers, Test_Kepribadian_Cache, Test_Kepribadian_Config } from "./Types.js";
import { Render_Test } from "../view/Render_Test.js";
import { Test_Kepribadian_API } from "../model/Test_Kepribadian_Api.js";
...
export class Test_Kepribadian {
    ...
    test_cache: Test_Kepribadian_Cache
    ...
    constructor(config: Test_Kepribadian_Config) {
        ...
        } : this.getTestKepribadianCache()!

        if (!this.getTestKepribadianCache()) {
    ...
    storeTestKepribadianCache(): void {
        Utility.storage("set", "test_kepribadian_cache", this.test_cache)
    }

    getTestKepribadianCache(): Test_Kepribadian_Cache | null {
        return Utility.storage("get", "test_kepribadian_cache") || null
    }
    nextQuestion(): void {
        this.question_index++
        this.RerenderContent()
